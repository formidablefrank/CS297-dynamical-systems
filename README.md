...
- **`Probset1/`** - First problem set with Mathematica notebooks (.nb) containing computations, alongside rendered plots documenting system behavior
- **`Probset2/`** - Second problem set with Mathematica notebooks and detailed LaTeX documentation
- **`Maple/`** - Maple worksheets for symbolic computation and specific dynamical system analysis
- **`Exam/`** - Course examination materials
- **`CS 297 Dynamical Systems.pdf`** - Course syllabus and lecture notes

To explore the work:

1. Open Mathematica notebook files (.nb) to view interactive computations and visualizations
